...
\begin{itemize*}
\item \textbf{P‰‰oma}: alkuper‰inen raham‰‰r‰ (talletusp‰‰oma tai lainap‰‰oma).
\item \textbf{Korkop‰iv‰}: p‰iv‰, jolta korkoa maksetaan; laskentatapoja on useita.
\item \textbf{Korkoaika}: aika, jolta korkoa maksetaan.
\item \textbf{Korkokausi} eli \textbf{korkojakso}: kertoo, kuinka usein korko liitet‰‰n p‰‰omaan.
\item \textbf{Korkokanta} eli \textbf{korkoprosentti}: yhden korkokauden korko prosentteina.
\item \textbf{Korkotekij‰}: kerroin, jonka avulla kasvanut p‰‰oma voidaan laskea.
\item \textbf{Kasvanut p‰‰oma}: p‰‰oma, johon korko on lis‰tty.
